...
def main(spark):
    ...
    movies = spark.read.csv('hdfs:/user/qy561_nyu_edu/ml-latest/movies.csv', header=True, inferSchema=True)

    # Convert to Parquet and save to HDFS directory
    movies.write.parquet('hdfs:/user/qy561_nyu_edu/ml-latest/movies.parquet')

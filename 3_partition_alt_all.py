...
def partition(spark, file_path):
    ...
    train_ratings.write.csv("hdfs:/user/qy561_nyu_edu/ml-latest/train_ratings_alt.csv", header=True)
    val_ratings.write.csv("hdfs:/user/qy561_nyu_edu/ml-latest/val_ratings_alt.csv", header=True)
    test_ratings.write.csv("hdfs:/user/qy561_nyu_edu/ml-latest/test_ratings_alt.csv", header=True)

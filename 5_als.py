...
def process_data(spark, userID):
    ...
    train_recommendations = get_recommendations(als_model, userID, 100)
    val_recommendations = get_recommendations(als_model, userID, 100)
    test_recommendations = get_recommendations(als_model, userID, 100)

    train_map = compute_map(train_recommendations, train_ratings, 100)
    val_map = compute_map(val_recommendations, val_ratings, 100)
    test_map = compute_map(test_recommendations, test_ratings, 100)

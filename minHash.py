...
def main(spark, userID):
    ...
    ratings_with_index_df.write.csv('hdfs:/user/{userID}/ml-latest-small/ratings_with_index.csv', header=True, mode="overwrite")
    ...
    ratings_df_grouped.write.csv('hdfs:/user/{userID}/ml-latest-small/ratings_df_grouped.csv', header=True, mode="overwrite")
    ...
    ratings_df_final.write.csv('hdfs:/user/{userID}/ml-latest-small/ratings_df_final.csv', header=True, mode="overwrite")
    ...
    top_100_pairs.write.csv('hdfs:/user/{userID}/ml-latest-small/top_100_pairs.csv', header=True, mode="overwrite")
